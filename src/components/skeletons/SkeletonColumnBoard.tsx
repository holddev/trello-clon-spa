...
export const SkeletonBoardColumn = ({ className }: Props) => {
  ...
  return (
    <article className={cn("flex flex-col gap-2 p-3 bg-white shadow-sm min-w-[250px] rounded-md animate-pulse", className)}>
      {/* Header */}
      ...
      <div className="flex flex-col gap-2 bg-gradient-to-br from-primary/50 to-violet-500/50 rounded-md p-2">
